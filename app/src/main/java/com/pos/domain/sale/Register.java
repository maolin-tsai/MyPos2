...
import com.pos.domain.inventory.Stock;
...
public class Register {
    ...
    {
       boolean bResult = saleDao.SqltabbleIsExist( tableName);
        return  bResult;
    }
}
