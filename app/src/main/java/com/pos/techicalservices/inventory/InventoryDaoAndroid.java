package com.pos.techicalservices.inventory;
...
import com.pos.domain.inventory.ProductLot;
...
//System.out.println("addproduct tablename="+DatabaseContents.TABLE_PRODUCT_CATALOG.toString());
//        System.out.println("addproduct name="+product.getName());
//        System.out.println("addproduct barcode="+product.getBarcode());
//        System.out.println("addproduct unitprice="+product.getUnitPrice());
    ...
    private List<Product> toProductList(List<Object> objectList) {
        ...
        for(Object object:objectList)
        {
            ...
            //  Product(int id, String name, String barcode, double salePrice) {
            list.add(new Product(content.getAsInteger("_id"),
    ...
    private List<Product> getAllProduct(String condition) {
       ...
       // boolean bresult = database.SqltabbleIsExist(DatabaseContents.TABLE_PRODUCT_CATALOG.toString());
        //System.out.println("getAllProduct="+bresult);
